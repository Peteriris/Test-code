            ...
            <div className="pt-3 ">
              <div class="container col-lg-4 pt-5 mt-3 border ps-4">
                <div class="row ">
                  <div class="col">
                    <div class="p-3 ">
                      <h1 class="text-primary col col-lg-2 ">Signup </h1>
                    </div>
                    <hr>
                    <div class="pt-3">
                    <form action="signinput.php" method="post" >
                        <div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="name" id="name" rows="3">
                            </div>
                            <center>
                                <div class="mb-3">
